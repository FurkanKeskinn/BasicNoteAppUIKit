...
public enum Asset {
  public enum Colors {
    ...
    public static let appPurple100 = ColorAsset(name: "appPurple_100")
    public static let appPurple50 = ColorAsset(name: "appPurple_50")
  ...
  public enum Icons {
    ...
    public static let icSuccess = ImageAsset(name: "ic_success")
